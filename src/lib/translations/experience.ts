    ...
    jobs: [
      {
        ...
        year: "2017",
        description: "Mats took on the task of adding Mapbox – alongside Google Maps – as a map provider for the web component in SMSI's flagship product. True to form, he also took the opportunity to introduce a number of quality improvements in the 4-year-old codebase; refactored and cleaned up to enable interactive debugging via WebStorm, introduced \"strict mode\" JavaScript, formalized existing code with ESLint, etc.\n\nEXAMPLE\nDeveloped an editable (and geodetically correct) \"spherical cap\" circle for WebGL.\nCode: https://github.com/smithmicro/mapbox-gl-circle/\nDemo: https://smithmicro.github.io/mapbox-gl-circle/ (see north pole)",
        technologies: "AngularJS, npm, ESLint, WebStorm, Mapbox.js, Mapbox GL, Turf.js, Browserify, Grunt, ES2015, LESS, Nginx, Wildfly, Docker",
        keywords: "System development"
      },
      {
        company: "Birdstep Technology",
        role: "Scrum Master + Lead DevOps Eng.",
        period: "2015-11–2017-08",
        year: "2015 - 2017",
        description: "Mats was responsible for design and implementation of a new solution that would replace the previous generation of Birdstep's analytics offering for teleoperators; a practical example of best practices:\n\n– New data transfer protocol with strict schema validation and KPI monitoring\n– API integration with the client's policy server for contextual processing of incoming data\n– Solid plugin architecture from the start; input data is split and streamed asynchronously to all activated receivers after initial validation – MongoDB, client APIs, AWS S3, Elasticsearch, Spark, etc.\n– Excellent horizontal scalability – completely without shared state\n– World-class documentation, over 500 current and strictly maintained test cases, with software distributed as RPM packages for RHEL 6 and 7\n– Self-monitoring and analytics reports via Elastic Stack\n\nMats also took over as system owner for the client's JIRA and implemented a series of improvements in the company's project processes. With this, vague and loosely specified user stories met their end. No user story enters a sprint in the Server Engineering team without well-defined acceptance criteria and time and complexity estimates, based on a clear understanding of 1) who wants it, 2) what they want and 3) for what purpose. And best of all; a couple of years later it's still the norm at every sprint planning meeting!",
        technologies: "Python, Sphinx, reST, Bitbucket, JSON Schema, XML Schema, Elastic Stack, Redis, RabbitMQ, Nginx, CentOS, Vagrant, Ansible, JIRA, Bamboo, Spark, Tomcat, Docker, RPM, Celery, S3",
        keywords: "Requirements analysis, IT architecture, system development, process development, configuration management"
      },
      {
    ...
    jobs: [
      {
        ...
        period: "2017-05–2017-09",
        year: "2017",
        description: "Mats tog sig an uppdraget att lägga till Mapbox – jämte Google Maps – som kartleverantör för webbkomponenten i SMSIs flaggskeppsprodukt. Sin vana trogen passade han även på att införa en rad kvalitetsförbättringar i den 4 år gamla kodbasen; refaktorerade och städade upp för att möjliggöra interaktiv debugging via WebStorm, införde \"strict mode\" JavaScript, formaliserade befintlig kodsstil med ESLint, m.m.",
        technologies: "AngularJS, npm, ESLint, WebStorm, Mapbox.js, Mapbox GL, Turf.js, Browserify, Grunt, ES2015, LESS, Nginx, Wildfly, Docker",
        keywords: "Systemutveckling"
      },
      {
        company: "Birdstep Technology",
        role: "Scrum Master + Lead DevOps Eng.",
